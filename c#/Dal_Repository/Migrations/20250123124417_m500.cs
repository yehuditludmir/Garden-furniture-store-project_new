...
{
    /// <inheritdoc />
    public partial class m500 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_buys_details", x => x.Id);
                    table.ForeignKey(
                        name: "FK_buys_details_buys_BuyId",
                        column: x => x.BuyId,
                        principalTable: "buys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_buys_details_products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_buys_details_BuyId",
                table: "buys_details",
                column: "BuyId");

            migrationBuilder.CreateIndex(
                name: "IX_buys_details_ProductId",
                table: "buys_details",
                column: "ProductId");
